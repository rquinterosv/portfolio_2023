const datosCV  = {
    ...
    experience: [
      {
        ...
        description: ['Coordinated cross-functional teams to ensure timely deliverables and alignment with project objectives.', 'Managed project schedules, optimizing workflow and ensuring on-time milestone achievements.', 'Oversaw project budgets, identifying cost-saving opportunities while ensuring profitability and quality standards.'],
      },
      {
      ...
      },
      {
        ...
        description: ['Developed interactive user interfaces using React.js, ensuring seamless integration with backend systems.', 'Implemented RESTful APIs and collaborated with backend developers to create scalable web applications.', 'Utilized modern development tools and libraries to optimize performance and user experience.'],
      },
      {
    ...
    education: [
      ...
      },
      {
        ...
        institution: 'Andres Bello University (Chile)',
        date: '2013 - 2018',
      },
      {
        degree: 'EF SET Certificate',
        institution: 'EF Standard English Test',
        date: '2022',
      },
      {
        degree: 'Scrum Foundation Certificate',
        institution: 'CetiProf International',
        date: '2021',
      },
    ],
    skills1: [
    ...
    certificates: [
      ...
      {
        title: 'Web Development Aceleration',
        issuer: 'Alkemy',
        date: '2021',
      },
      {
        title: 'Scrum Foundation Certificate',
        issuer: 'CetiProf International',
        date: '2021',
      },
      // Agrega más certificados si los tienes
    ],
    languages: [
      {
        language: 'English',
